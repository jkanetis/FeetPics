...
def set_tingling_mode():
    ...
    # Update button highlighting - use shadow instead of background color
    plotter.remove_actor("tingling_button")
    plotter.remove_actor("numbness_button")
    # Highlight tingling button by making it bold with blue color
    plotter.add_text("TINGLING", position=(window_width - 150, 10), font_size=16, 
                     color="blue", name="tingling_button", shadow=True)
    plotter.add_text("Numbness", position=(window_width - 150, 50), font_size=16, 
                     color="red", name="numbness_button")
    
    # Show description in bottom left corner
    if "sensation_desc" in plotter._actors:
        plotter.remove_actor("sensation_desc")
    
    # Add description text at bottom left with bigger font and BLACK color
    plotter.add_text("Info to be Added...", position=(20, window_height - 40), font_size=16, 
                    color="black", name="sensation_desc")
...
def set_numbness_mode():
    ...
    plotter.remove_actor("numbness_button")
    plotter.add_text("Tingling", position=(window_width - 150, 10), font_size=16, 
                     color="blue", name="tingling_button")
    # Highlight numbness button by making it bold with red color
    plotter.add_text("NUMBNESS", position=(window_width - 150, 50), font_size=16, 
                     color="red", name="numbness_button", shadow=True)
